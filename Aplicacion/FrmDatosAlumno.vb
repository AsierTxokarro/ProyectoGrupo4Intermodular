...
Public Class FrmDatosAlumno
    Private Sub BtnAnadir_Click(sender As Object, e As EventArgs) Handles BtnAnadir.Click
        ...
        Else
            MessageBox.Show(usadoParaGestion.AñadirAlumno(txtDNI.Text, txtHorasTotales.Text, txtNombre.Text, txtApellidoUno.Text, txtApellidoDos.Text, Ciclos.SelectedIndex, Cursos.SelectedIndex, True, "Añadir un campo para decir porque si o no"))
        End If
